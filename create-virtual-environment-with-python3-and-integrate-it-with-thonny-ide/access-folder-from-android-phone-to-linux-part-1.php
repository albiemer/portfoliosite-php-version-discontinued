				...
				<article class = "center">
					<h1>"Hi i am Albie the creator of this site.."</h1>
						...
						<p>I am more capable to build website with Python Flask.</p>
							...
							<h1>Access Folder From Android Phone To Linux OS Part 1</h1>
							<iframe width="560" height="315" src="https://www.youtube.com/embed/2Byeshz3SBs?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							<br>
					...
					<section class = "right">
						...
						<b>Previous VLOG</b>
						<br><br>
						<a href = "access-windows-shared-folder-from-linux-system.php">
						<img src="vlogimages/access-windows-shared-folder-from-linux-system/AWSFFLS.jpg" alt="Mountain View" style="width:100%; height:100%">
						</a>
