...
if (isset($_SESSION['LOGINEMAIL'])){
	...
	if (isset($_POST['EMAIL']) && isset($_POST['TEXTAREAREPLYCOMMENT']) && isset($_POST['ID']) ){
		...
		if($email_s == $email){
			...
			header("Location:feedback-and-reviews.php#replyedit");
			...
			header("Location:feedback-and-reviews.php#thisisnotyoursubcommentedit");
	...
	header("Location:feedback-and-reviews.php#SignUp");
