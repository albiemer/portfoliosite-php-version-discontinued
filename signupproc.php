...
if (isset($_POST['SIGNUPFNAME']) && isset($_POST['SIGNUPLNAME']) && isset($_POST['SIGNUPEMAIL']) && isset($_POST['SIGNUPWEBSITE'])){
			...
			if($_POST['PPASSWORD'] === $_POST['CONFIRMPASSWORD']){
				...
				$read = "SELECT * FROM $dbuser WHERE Email = '$signupemail' ";
				...
				if ($result->num_rows>0){
					...
					$sql = "INSERT INTO $dbuser (Fname, Lname, Email, Password, Date, Weekdays, Time, Website) VALUES ('$signupfname', '$signuplname', '$signupemail', '$ppassword', '$date', '$weekdays', '$time', '$signupwebsite')";
							...
							$_SESSION['SIGNUPERRORFORM'] = '<div id="SignUp" class="modalDialog">
								<div>
									...
									<form action = "signupproc.php" method = "post">
										...
										<h5 style = "color:blue;">You are now registered, You may now login. Thanks for subscription.</h5>
