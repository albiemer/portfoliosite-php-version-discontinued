				...
				<article class = "center">
					<h1>"Hi i am Albie the creator of this site.."</h1>
						...
						<p>I am more capable to build website with Python Flask.</p>
							...
							<BR><a href = "http://albiemer.duckdns.org/create-virtual-environment-with-python3-and-integrate-it-with-thonny-ide/bloggs.php#step4">CLICK HERE TO CONTINUE READING ARTICLE...</a>
							<br></h4>
							<hr><br>
					...
					<section class = "left">
						...
						echo '<form method = "post" action = "uploadpic.php" enctype="multipart/form-data">
							...
							<button type="submit upload" name="uploadfile">upload now</button>
						</form>';
