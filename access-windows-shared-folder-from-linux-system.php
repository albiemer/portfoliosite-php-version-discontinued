			...
			<?php 
				...
				if (isset($_SESSION['LOGINEMAIL'])){
					...
					echo '<div id="fb-root" class = "fb-root" >
						...
						$fname_s . " " . $lname_s . '</a><form action = "/home/logout.php" style = "float: right;"><input type = "submit" name = "submit" style = "font-size: 10px;" method = "post" value = "Logout" = ></form>
				...
				<article class = "center">
					<h1>"Hi i am Albie the creator of this site.."</h1>
						...
						<p>I am more capable to build website with Python Flask.</p>
							...
							<h1>Access Windows Shared Folder From Linux System</h1>
							<iframe width="560" height="315" src="https://www.youtube.com/embed/Di7dg2D4cDA?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							<br>
					...
					<section class = "left">
						...
						<img src="images/me.jpg" style = "width: 55%; height: auto;" alt="Italian Trulli">
					...
					<section class = "right">
						...
						<b>Previous VLOG</b>
						<br><br>
						<a href = "https://www.youtube.com/watch?v=Di7dg2D4cDA&t=106s">
						<img src="vlogimages/keepass2android-part-2-with-keyboardswap-configuration/K2AP2KSC.jpg" alt="Mountain View" style="width:100%; height:100%">
						</a>
						<h4>This tutorial is about how to use keepass2android with keyboardswap configuration.</h4>
						<hr>
						<h4>Messages</h4>
